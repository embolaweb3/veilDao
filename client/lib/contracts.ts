...
export const VEILDAO_ABI = [
  ...
  },
  {
    ...
    name: "ProposalResolved", type: "event",
  },
  {
    anonymous: false,
    inputs: [
  ...
  },
  {
    ...
    inputs: [
      { indexed: true,  internalType: "uint256", name: "proposalId", type: "uint256" },
      { indexed: false, internalType: "uint32",  name: "margin",     type: "uint32"  },
      { indexed: false, internalType: "uint32",  name: "totalVotes", type: "uint32"  },
    ],
    name: "AnalyticsPublished", type: "event",
  },
  {
    anonymous: false,
    inputs: [
  ...
  },
  {
    ...
    name: "WeightedVoteCast", type: "event",
  },
  ...
  {
    inputs: [{ internalType: "uint256", name: "", type: "uint256" }, { internalType: "address", name: "", type: "address" }],
    name: "voteWeight", outputs: [{ internalType: "uint8", name: "", type: "uint8" }], stateMutability: "view", type: "function",
  },
  {
    inputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    name: "voterCount", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function",
  },
  {
  ...
  {
    inputs: [{ internalType: "uint256", name: "min_", type: "uint256" }, { internalType: "uint256", name: "max_", type: "uint256" }],
...
export const CONTRACT_ADDRESSES: Record<number, `0x${string}`> = {
  ...
  421614:   "0xdE21971e44DB426b87B17C40eaC54E212bdCa7EB", // arb-sepolia — update after GhostGov deploy
};
